...
- **KARAR (2026-08-09): Resco Mail Yönetim paneli `mailprovider.rescopos.com`'a kurulacak** (subdomain'i Bülent Plesk'ten tanımlar; SSL = mevcut wildcard). Tasarım: [docs/YONETIM_TASARIM.md](docs/YONETIM_TASARIM.md) — görsel sunum onaylı, kod tasarım onayı sonrası.
